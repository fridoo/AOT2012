...
public final class Window extends AbstractMethodExposingBean {
	...
	public static final String ACTION_UPDATE_WINDOW_STATE = "Window.updateState";
	 ...
	 */
	@Expose(name = ACTION_GET_WINDOW_STATE, scope = ActionScope.GLOBAL)
	public Boolean getWindowState() {
		return this.isOpen;
	}
	
	@Expose(name = ACTION_UPDATE_WINDOW_STATE, scope = ActionScope.AGENT)
	public void updateState(Boolean newState) throws Exception {
